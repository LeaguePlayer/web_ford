<?php
/**
 * Миграция m130824_120944_menu
 *
 * @property string $prefix
 */
 
class m130824_120944_menu extends CDbMigration
{
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{menu}}', array(
			...
			'id_site' => "integer COMMENT 'Показывается на сайте'",
			'id_category' => "tinyint COMMENT 'Отновится к категории'",
			
			'title' => "string COMMENT 'Заголовок меню'",
			'link' => "string COMMENT 'Ссылка'",
			
			'show_on_main' => "tinyint COMMENT 'Показывать в меню на главной'",
