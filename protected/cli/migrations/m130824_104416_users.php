<?php
/**
 * Миграция m130824_104416_users
 *
 * @property string $prefix
 */
 
class m130824_104416_users extends CDbMigration
{
    // таблицы к удалению, можно использовать '{{table}}'
	private $dropped = array('{{users}}');
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{users}}', array(
			...
			'id_site' => "integer COMMENT 'К какому сайту отновится'",
			
			'login' => "string COMMENT 'Логин пользователя'",
