<?php
/**
 * Миграция m130826_073515_static_page
 *
 * @property string $prefix
 */
 
class m130826_073515_static_page extends CDbMigration
{
    // таблицы к удалению, можно использовать '{{table}}'
	private $dropped = array('{{static_page}}');
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{static_page}}', array(
			...
			'title' => "string COMMENT 'Заголовок страницы'",
