<?php
/**
 * Миграция m130824_124105_object_relations
 *
 * @property string $prefix
 */
 
class m130824_124105_object_relations extends CDbMigration
{
    // таблицы к удалению, можно использовать '{{table}}'
	private $dropped = array('{{object_relations}}');
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{object_relations}}', array(
